...
* 联想 同一个型号的电脑，在中国比在国外价格高，用国内消费者的钱补贴外国消费者
  * 联想喜提新绰号：美帝良心想
* Apple
...
* 拼多多
  ...
  * 拼多多向用户的手机里塞入后门（内嵌提权代码+动态下发dex）
    * 我个人得说两句：我之前把这件事发在知乎上，阅读量还不算太大，没多少点赞呢，上海寻梦信息技术有限公司不知道是不是搜着关键词就过来了，对着我有证据有道理的回答当场就是一个举报，知乎也是秒怂，立刻就删掉了。敢情拼多多的法务部是不是整天就干这种事儿啊。这点儿气量，这点儿德行，难怪能把法务部干成盈利部门。至于塞没塞后门，大家自己点开下面的链接看吧。我算是累了。
...
* Google
  * Google正在封闭Android，要求所有开发者进行注册，否则无法分发应用。用户也将失去在自己的手机上安装任意应用的权限。
    * [Keep Android Open](https://keepandroidopen.org/)
    * 这将让Google拥有封杀自己不喜欢的开发者的权力，同时也有可能配合政府对应用进行封杀。
    * 被封杀的应用可能对自由至关重要——比如VPN，毕竟现在不仅仅只有中国有GFW了。
