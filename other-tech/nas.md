...
网络附加存储（英语：Network Attached Storage，缩写：NAS），粗略地说，就是可以网络访问的一个硬盘。如果你没有概念，可以先阅读一下Wiki：[NAS 维基百科](https://zh.wikipedia.org/wiki/%E7%B6%B2%E8%B7%AF%E9%99%84%E5%8A%A0%E5%84%B2%E5%AD%98)，如果你没法翻墙，可以阅读：[NAS 百度百科](https://baike.baidu.com/item/NAS/3465615)。
...
3. 颗粒的花样就多了：
    ...
    - 批次：颗粒是需要调校的，准确地说调整的不是颗粒是主控。如果不是同一个批次，调校就无从谈起，就会有性能和稳定性的问题。
...
广义地说，兼容Amazon S3接口的存储程序，比如Minio或者SeaweedFS，乃至MySQL或者MongoDB这种数据库也算是网络存储。
