...
梯度方向有了，接下来就是学习率了，和机器学习任务不一样，这里的学习率是可以有最优解的， 原理大概是：如果沿着梯度方向前后走，并且记录路径上L的大小，那么我们会得到一个抛物线。
...
这个方法的思路是，不走回头路，如果每一次新的搜索方向都与之前的所有搜索方向张成的子空间共轭（即A-正交），那么可以更加高效。
