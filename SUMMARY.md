...
* [机器学习](ml/README.md)
  ...
  * [推荐系统](ml/recsys/README.md)
    * [Understanding LightGCN in a visualized way](ml/recsys/light\_gcn.md)
    * [Learning To Rank 之 RankNet](ml/recsys/ranknet.md)
    * [随想： BPR Loss 与 Hinger Loss](ml/recsys/bpr\_and\_hinger.md)
    * [关于AA测试和AB测试的一些思考](ml/recsys/ab\_testing.md)
    * [无采样的矩阵分解](ml/recsys/non\_sampling\_mf.md)
...
* [高级物理引擎实战指南笔记](game201/README.md)
  * [弹簧质点系统](game201/mass\_spring.md)
  * [光滑粒子法](game201/sph.md)
  * [专题：线性方程组求解](game201/linear\_eq\_solver.md)
* [有限单元法](FEM/README.md)
...
* [技术杂文](other-tech/README.md)
  ...
  * [为FFMPEG添加Intel QSV支持](other-tech/ffmpeg\_qsv.md)
...
* [随园食单](recipe/README.md)
  * [ボロネーゼ](recipe/spaghetti\_bolognese.md)
